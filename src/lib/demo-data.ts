...
export const notifications: NotificationItem[] = [
  {
    ...
    description: "Building-wide fire drill on 24 Jun 2026 at 10:00. Please use staircases and gather at the podium assembly point.",
    level: "critical",
    timeLabel: "24 Jun 2026 · 10:00",
    critical: true,
  },
  {
    id: "notif-2",
    title: "Lift repair schedule",
    description: "Tower B lift no.2 will be under maintenance on 25 Jun 2026 from 09:00 to 18:00. Please plan travel time accordingly.",
    level: "warning",
    timeLabel: "25 Jun 2026 · 09:00-18:00",
    critical: true,
  },
  {
    id: "notif-3",
    title: "Construction noise notice",
    description: "External facade works near tower C will run on 26 Jun 2026 from 13:00 to 17:00. Expect intermittent drilling noise.",
    level: "info",
...
const notificationsZhHK: NotificationItem[] = [
  {
    id: "notif-1",
    title: "消防演習通知",
    description: "全棟將於 2026年6月24日 10:00 進行消防演習。請使用樓梯並到平台集合點集合。",
    level: "critical",
    timeLabel: "2026年6月24日 · 10:00",
    critical: true,
  },
  {
    id: "notif-2",
    title: "升降機維修安排",
    description: "B座2號升降機將於 2026年6月25日 09:00 至 18:00 進行維修，請預留額外出入時間。",
    level: "warning",
    timeLabel: "2026年6月25日 · 09:00-18:00",
    critical: true,
  },
  {
    id: "notif-3",
...
export const nearbyShops: PlaceItem[] = [
  {
    ...
    description: "Local grocer with same-day fruit, pantry, floral bundles, and weekend resident pick-up slots.",
    details: [
    ...
    phone: "+852 2456 7821",
    website: "https://harborfreshmarket.example",
    lat: 22.2853,
    lng: 114.1549,
  ...
  },
  {
    ...
    description: "Casual all-day cafe with private corner booking, coffee workshops, and small celebration menus.",
    details: [
    ...
    phone: "+852 2890 1432",
    website: "https://sunrisecafe-loft.example",
    lat: 22.2821,
    lng: 114.1586,
  ...
  },
  {
    ...
    description: "Late-closing neighborhood pharmacy with medicine pickup, wellness advice, and weekend screenings.",
    details: [
    ...
    phone: "+852 2788 6543",
    website: "https://wellnestpharmacy.example",
    lat: 22.2838,
    lng: 114.1518,
...
export const nearbyCommunities: CommunityItem[] = [
  {
    ...
    description: "Monthly social and mutual-help meetups around family activities, learning circles, and newcomer onboarding.",
    details: [
    ...
    phone: "+852 6112 4300",
    website: "https://harborfrontnetwork.example",
    lat: 22.2868,
    lng: 114.1604,
  ...
  },
  {
    ...
    description: "Sustainability-focused group hosting swap tables, repair workshops, cleanups, and reuse education sessions.",
    details: [
    ...
    phone: "+852 6770 1882",
    website: "https://greenstepsclub.example",
    lat: 22.2804,
    lng: 114.1564,
